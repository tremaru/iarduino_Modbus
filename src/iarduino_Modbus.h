...
//  Версия: 1.0.3
//  Последнюю версию библиотеки Вы можете скачать по ссылке: https://iarduino.ru/file/591.html
//  Подробное описание функции бибилиотеки доступно по ссылке: https://wiki.iarduino.ru/page/Modbus-RS485/
...
class ModbusClient{																					//
	...
	/**	Пользовательские функции **/																//
		...
		uint8_t		checkID					(uint8_t id											);	//	Объявляем функцию проверки устройств.													Параметры функции: SlaveID 1-255. Возвращает DEVICE_MB_ABSENT/DEVICE_MB_DOUBLE/DEVICE_MB_UNKNOWN/DEVICE_MB_IARDUINO.
		...
		uint8_t		getName					(uint8_t id=0										);	//	Объявляем функцию чтения названия устройства.											Параметры функции: id модуля. Функция возвращает количество байт строки с названием устройства, доступных для чтения функцией read() и available().
